...
const en: Dict = {
  ...
  'auth.noUser': 'No account with that username.',
  ...
  'auth.tagline': 'Discipline is a habit.',
  'auth.error': 'Something went wrong',
  'auth.forgot': 'Forgot password?',
  'auth.resetTitle': 'Reset your password',
  'auth.resetDesc': "Enter your account email — we'll send a reset link.",
  'auth.sendReset': 'Send reset link',
  'auth.resetSent': 'Reset link sent! Check your email (and spam).',
  ...
  'fixed.dup': 'That daily task already exists.',
  // shop
  ...
  'shop.needMore': 'Need ¥{amount} more',
  'shop.enjoy': 'Enjoy your {name}!',
  'shop.greeting': 'Welcome in! Treat yourself — you earned it.',
  'shop.game': 'Play games',
  'shop.meal': 'Cheat meal',
  'shop.sleep': 'Sleep in',
  'shop.game.desc': 'An hour of guilt-free play',
  'shop.meal.desc': 'Something tasty, no regrets',
  'shop.sleep.desc': 'Hit snooze — you earned it',
  // ranking
...
const zh: Dict = {
  ...
  'auth.tagline': '自律是一种习惯。',
  'auth.error': '出错了',
  'auth.forgot': '忘记密码？',
  'auth.resetTitle': '重置密码',
  'auth.resetDesc': '输入你的账号邮箱，我们会发送重置链接。',
  'auth.sendReset': '发送重置链接',
  'auth.resetSent': '重置链接已发送！请查收邮件（也看看垃圾箱）。',
  ...
  'fixed.dup': '这个每日必做已经存在了。',
  'shop.rewards': '奖励',
  'shop.title': '商店',
  'shop.spend': '花掉你辛苦赚来的金币——无愧疚。',
  'shop.buy': '购买',
  'shop.tooPricey': '买不起',
  'shop.needMore': '还差 ¥{amount}',
  'shop.enjoy': '享受你的{name}！',
  'shop.greeting': '欢迎光临！犒劳一下自己——你值得。',
  'shop.game': '玩游戏',
  'shop.meal': '欺骗餐',
  'shop.sleep': '睡懒觉',
  'shop.game.desc': '一小时无负担畅玩',
  'shop.meal.desc': '来点好吃的，不必愧疚',
  'shop.sleep.desc': '睡到自然醒，你值得',
